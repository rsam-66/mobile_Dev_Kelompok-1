...
class _HomePageState extends State<HomePage> {
  static const baseUrl = 'http://192.168.1.11:80';
  ...
  AppBar _buildAppBar() {
    return AppBar(
      ...
      title: Row(
        ...
        children: [
          Image.asset("asset/logo_rz.png", height: 40),
          Row(
            children: [
              IconButton(
...
class ItemCard extends StatelessWidget {
  ...
  Widget _buildImage() {
    final imageUrl = '${_HomePageState.baseUrl}/${barang.gambar}';
    print('Image URL: $imageUrl'); // Debug print statement
    return ClipRRect(
      borderRadius: BorderRadius.circular(12),
      child: Image.network(
        'http://192.168.1.11:80/uploads/1736264460609.png',
        height: 160,
